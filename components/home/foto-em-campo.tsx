...
/**
 * Seção "Em palco" — quebra a monotonia textual da Home com
 * uma imagem grande do CEO em workshop/evento institucional,
 * lado a lado com um statement curto.
 */
    ...
    <section className="relative py-28 lg:py-40 bg-[color:var(--color-surface)] border-t border-[color:var(--color-hairline)] overflow-hidden">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-20 items-center">
          ...
          {/* Coluna direita: statement + 3 indicadores */}
          <div className="space-y-12">
            <Reveal>
              ...
              <h2 className="font-serif text-display-md lg:text-display-lg leading-[0.95] tracking-tight">
                Tributário não<br />
                se resolve <span className="italic text-[color:var(--color-brand)]">no PDF.</span>
              </h2>
            </Reveal>

            <Reveal delay={0.1}>
              <p className="text-[16px] lg:text-[17px] leading-relaxed text-[color:var(--color-ink-muted)] max-w-md">
                Visitamos a operação. Entendemos o galpão, a linha de
                produção, a cadeia de suprimento. É de lá que sai a tese —
                não do escritório.
              </p>
            </Reveal>

            {/* 3 indicadores horizontais */}
            <Reveal delay={0.2}>
